  ...
  return (
    <div className='about' >
      ...
      <p>
         ...
         we have the right solution for you. At myElectroVault, we don’t just sell products—we offer solutions that meet your needs with exceptional customer service,
